...
$title="123";
$contents="123";
$smtpemailto="1611337277@qq.com";

$smtpserver = "smtp.163.com";//SMTP服务器
$smtpserverport =25;//SMTP服务器端口
$smtpusermail = "m13761460087@163.com";//SMTP服务器的用户邮箱
//        $smtpemailto = "1611337277@qq.com";//发送给谁
$smtpuser = "m13761460087@163.com";//SMTP服务器的用户帐号，注：部分邮箱只需@前面的用户名
$smtppass = "qwer12345";//SMTP服务器的授权码
$mailtitle = $title;//邮件主题
$mailcontent = $contents;//邮件内容
$mailtype = "HTML";//邮件格式（HTML/TXT）,TXT为文本邮件
//************************ 配置信息 ****************************
$smtp=new SmtpModel($smtpserver,$smtpserverport,true,$smtpuser,$smtppass);
